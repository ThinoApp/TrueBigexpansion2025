...
const projects = [
  ...
  },
  {
    ...
    year: "2024",
    category: "Équipements Sportifs",
    description: "Rénovation complète d'un complexe sportif avec création d'un terrain multisports et modernisation des vestiaires",
    image: "/images/Realisations/ORLEANS_COMPLEXE.jpg",
    stats: ["Terrain multisports", "Vestiaires modernisés", "Éclairage LED"],
    tags: ["#Multisports", "#Rénovation", "#ÉquipementSportif"],
  },
  {
    id: 5,
    title: "STADE DE RUGBY - TOURS",
    location: "TOURS 37000",
    year: "2024",
    category: "Équipements Sportifs",
    description: "Construction d'un nouveau stade de rugby avec tribune couverte et système d'arrosage automatique",
    image: "/images/Realisations/TOURS_RUGBY.jpg",
