...
const projects = [
  ...
  },
  {
    ...
    category: "Équipements Sportifs",
    description:
      "Rénovation complète d'un complexe sportif avec création d'un terrain multisports et modernisation des vestiaires",
    image: "/images/Realisations/Lieusaint.jpg",
    stats: ["Terrain multisports", "Vestiaires modernisés", "Éclairage LED"],
    tags: ["#Multisports", "#Rénovation", "#ÉquipementSportif"],
  },
  {
    id: 5,
    ...
    category: "Équipements Sportifs",
    description:
      "Construction d'un nouveau stade de rugby avec tribune couverte et système d'arrosage automatique",
    image: "/images/Realisations/Tribunes Bourges.jpg",
    stats: ["Stade de rugby", "Tribune 500 places", "Arrosage automatique"],
    tags: ["#Rugby", "#Construction", "#ÉquipementSportif"],
  },
  // {
  //   id: 2,
