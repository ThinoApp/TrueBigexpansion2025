...
const projects = [
  {
    ...
    image: "/images/Realisations/Photo 1.JPG",
  ...
  },
  {
    ...
    image: "/images/Realisations/Photo 2.jpg",
  ...
  },
  {
    ...
    image: "/images/Realisations/Photo 3.JPG",
    stats: ["Terrain de football", "Gazon synthétique", "Éclairage LED"],
    tags: ["#Football", "#GazonSynthétique", "#ÉquipementSportif"],
  },
  {
    id: 4,
    title: "LIEUSAINT - RÉNOVATION COUVERTURE ET SURFACES TENNIS",
    location: "LIEUSAINT 77127",
    year: "2025",
    category: "Équipements Sportifs",
    description:
      "Rénovation complète de la couverture et remise à neuf des surfaces de tennis avec revêtement haute performance",
    image: "/images/Realisations/Lieusaint.jpg",
    stats: ["Courts de tennis", "Couverture rénovée", "Revêtement haute performance"],
    tags: ["#Tennis", "#Rénovation", "#Couverture"],
  },
  {
    id: 5,
    title: "BOURGES - TRIBUNES STADE JEAN BRIVOT",
    location: "BOURGES 18000",
    year: "2025",
    category: "Équipements Sportifs",
    description:
      "Construction de nouvelles tribunes modernes pour le stade Jean Brivot avec structure métallique et gradins couverts",
    image: "/images/Realisations/Tribunes Bourges.jpg",
    stats: ["Tribunes modernes", "Structure métallique", "Gradins couverts"],
    tags: ["#Tribunes", "#Construction", "#StadeFootball"],
  },
  // {
  //   id: 2,
